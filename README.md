...
- A *metadata.yml* file containing information about the `Tome`, like the amount of versions of said `Tome` that are available for download, what the latest version and the *LTS* version of said `Tome` are, and more.
