...
- Several *\<Tome-name>_\<Tome-version>.yml* files, each containing the *name* of the package, it's *version*, the *url* from where it will be downloaded, and the *type* of file that will be downloaded (e.g. zip, tar, etc.)
